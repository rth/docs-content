...
Access your Edge Services dashboard in the Scaleway console via the shortcut in Edge Services tab of the bucket in question. Note that you will first need to [activate](https://www.scaleway.com/en/docs/observability/cockpit/how-to/activate-cockpit/) Cockpit, and [create a Grafana user and credentials](https://www.scaleway.com/en/docs/observability/cockpit/how-to/retrieve-grafana-credentials/).
